# Speaker scripts by person

Each teammate has everything they say, in speaking order, in one file. Two versions per person:

- `<name>-points.md` — bullet points to hold during the talk.
- `<name>-full.md` — word-for-word wording + "If they ask" answers, to rehearse.
