...
- **Salim** — Graphics (3D Pong, Three.js, physics); Gameplay (Tic-Tac-Toe + online matchmaking + history); Cybersecurity & GDPR (anonymize, export, delete, retention, privacy policy).
...
- What we learned: full-stack with Django + JS SPA + Three.js + PostgreSQL in Docker; online game logic; deployment; security.
- Agile + feature branches kept 4 people productive.
- Solid base for the future: real-time online Pong, chat, richer AI.
