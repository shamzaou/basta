...
banner("banner-team.jpg", "Testing Strategy",
       ...
       cards([("Unit tests", "Django test suite (<code>make test</code>) — 57 tests across userapp, gameapp and tournaments: login and the whole 2FA flow, GDPR export / anonymize / delete, the inactive-account command, tournament tiebreakers, Tic-Tac-Toe matchmaking and moves, server-side rendering."),
